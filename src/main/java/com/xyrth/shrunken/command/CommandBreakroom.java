        ...
        switch (args[0]) {
            ...
            case "pos1":
                ...
                sender.addChatMessage(
                    new ChatComponentText("Pos1 set to " + pos1[0] + ", " + pos1[1] + ", " + pos1[2] + ", "));
            ...
            case "pos2":
                ...
                sender.addChatMessage(
                    new ChatComponentText("Pos2 set to " + pos2[0] + ", " + pos2[1] + ", " + pos2[2] + ", "));
                updateBreakroomConfig();
                break;
            ...
            case "current":
                sender.addChatMessage(
                    new ChatComponentText(
                        "Pos1: " + BreakroomConfig.minX + ", " + BreakroomConfig.minY + ", " + BreakroomConfig.minZ));
                sender.addChatMessage(
                    new ChatComponentText(
                        "Pos2: " + BreakroomConfig.maxX + ", " + BreakroomConfig.maxY + ", " + BreakroomConfig.maxZ));
                break;
