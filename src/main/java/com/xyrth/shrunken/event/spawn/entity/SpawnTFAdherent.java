...
public class SpawnTFAdherent extends GenericSpawnEvent {

    public SpawnTFAdherent(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
