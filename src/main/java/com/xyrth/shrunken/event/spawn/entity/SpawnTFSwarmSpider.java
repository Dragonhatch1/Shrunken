...
public class SpawnTFSwarmSpider extends GenericSpawnEvent {

    public SpawnTFSwarmSpider(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
