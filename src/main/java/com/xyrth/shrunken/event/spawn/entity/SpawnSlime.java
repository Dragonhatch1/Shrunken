...
public class SpawnSlime extends GenericSpawnEvent {

    public SpawnSlime(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
