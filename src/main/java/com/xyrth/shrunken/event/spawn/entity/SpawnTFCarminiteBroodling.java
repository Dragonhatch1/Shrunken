...
public class SpawnTFCarminiteBroodling extends GenericSpawnEvent {

    public SpawnTFCarminiteBroodling(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
