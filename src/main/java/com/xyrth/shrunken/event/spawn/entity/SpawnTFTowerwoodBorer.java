...
public class SpawnTFTowerwoodBorer extends GenericSpawnEvent {

    public SpawnTFTowerwoodBorer(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
