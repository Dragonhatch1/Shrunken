...
public class SpawnTFKobold extends GenericSpawnEvent {

    public SpawnTFKobold(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
