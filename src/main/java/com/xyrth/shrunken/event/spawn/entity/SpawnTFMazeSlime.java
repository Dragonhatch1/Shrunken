...
public class SpawnTFMazeSlime extends GenericSpawnEvent {

    public SpawnTFMazeSlime(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
