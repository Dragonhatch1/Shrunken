...
public class SpawnTFCarminiteGolem extends GenericSpawnEvent {

    public SpawnTFCarminiteGolem(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
