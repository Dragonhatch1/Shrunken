...
public class SpawnTFWinterWolf extends GenericSpawnEvent {

    public SpawnTFWinterWolf(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
