...
public class SpawnTFBossKnightPhantom extends GenericSpawnEvent {

    public SpawnTFBossKnightPhantom(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
