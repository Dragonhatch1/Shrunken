...
public class SpawnTFRedcap extends GenericSpawnEvent {

    public SpawnTFRedcap(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
