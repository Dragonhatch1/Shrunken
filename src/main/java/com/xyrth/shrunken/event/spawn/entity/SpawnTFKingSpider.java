...
public class SpawnTFKingSpider extends GenericSpawnEvent {

    public SpawnTFKingSpider(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
