...
public class SpawnTFPenguin extends GenericSpawnEvent {

    public SpawnTFPenguin(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
