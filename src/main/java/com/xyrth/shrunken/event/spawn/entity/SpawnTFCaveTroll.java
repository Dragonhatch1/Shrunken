...
public class SpawnTFCaveTroll extends GenericSpawnEvent {

    public SpawnTFCaveTroll(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
