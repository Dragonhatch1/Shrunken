...
public class SpawnTFMinoshroom extends GenericSpawnEvent {

    public SpawnTFMinoshroom(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
