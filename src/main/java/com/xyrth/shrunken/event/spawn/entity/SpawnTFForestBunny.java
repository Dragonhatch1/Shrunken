...
public class SpawnTFForestBunny extends GenericSpawnEvent {

    public SpawnTFForestBunny(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
