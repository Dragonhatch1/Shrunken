...
public class SpawnTFBossMinotaur extends GenericSpawnEvent {

    public SpawnTFBossMinotaur(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
