...
public class SpawnTFBossSnowQueen extends GenericSpawnEvent {

    public SpawnTFBossSnowQueen(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
