...
public class SpawnTFPinchBeetle extends GenericSpawnEvent {

    public SpawnTFPinchBeetle(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
