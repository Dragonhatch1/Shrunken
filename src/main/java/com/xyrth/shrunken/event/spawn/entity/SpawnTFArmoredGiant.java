...
public class SpawnTFArmoredGiant extends GenericSpawnEvent {

    public SpawnTFArmoredGiant(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
