...
public class SpawnZombie extends GenericSpawnEvent {

    public SpawnZombie(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
