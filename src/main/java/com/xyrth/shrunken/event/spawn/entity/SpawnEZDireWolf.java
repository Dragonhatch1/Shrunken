...
public class SpawnEZDireWolf extends GenericSpawnEvent {

    public SpawnEZDireWolf(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
        double spd, String username, int amount) {
        super(world, x, y, z, targetEntity, hp, att, spd, username, amount);

        int l = 0;
        while (l < amount) {
            String mobName = "enderzoo.DireWolf";
