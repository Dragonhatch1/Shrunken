...
public class SpawnTFHelmetCrab extends GenericSpawnEvent {

    public SpawnTFHelmetCrab(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
