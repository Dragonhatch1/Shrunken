...
public class SpawnTFTwilightWraith extends GenericSpawnEvent {

    public SpawnTFTwilightWraith(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
