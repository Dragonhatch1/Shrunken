...
public class SpawnTFDeathTome extends GenericSpawnEvent {

    public SpawnTFDeathTome(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
