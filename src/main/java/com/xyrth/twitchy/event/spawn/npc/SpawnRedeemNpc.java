...
public class SpawnRedeemNpc extends GenericNpcEvent {

    public SpawnRedeemNpc(World world, double x, double y, double z, EntityLivingBase targetEntity, String username,
