...
public class SpawnTFMosquitoSwarm extends GenericSpawnEvent {

    public SpawnTFMosquitoSwarm(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
