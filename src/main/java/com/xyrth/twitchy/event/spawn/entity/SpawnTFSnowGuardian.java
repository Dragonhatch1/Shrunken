...
public class SpawnTFSnowGuardian extends GenericSpawnEvent {

    public SpawnTFSnowGuardian(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
