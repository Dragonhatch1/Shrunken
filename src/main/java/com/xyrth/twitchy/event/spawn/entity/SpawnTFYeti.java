...
public class SpawnTFYeti extends GenericSpawnEvent {

    public SpawnTFYeti(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
