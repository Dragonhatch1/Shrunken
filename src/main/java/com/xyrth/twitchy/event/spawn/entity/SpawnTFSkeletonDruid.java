...
public class SpawnTFSkeletonDruid extends GenericSpawnEvent {

    public SpawnTFSkeletonDruid(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
