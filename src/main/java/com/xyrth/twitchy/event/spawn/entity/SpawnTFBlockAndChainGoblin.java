...
public class SpawnTFBlockAndChainGoblin extends GenericSpawnEvent {

    public SpawnTFBlockAndChainGoblin(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
