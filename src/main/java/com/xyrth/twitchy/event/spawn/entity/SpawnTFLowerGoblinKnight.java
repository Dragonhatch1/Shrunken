...
public class SpawnTFLowerGoblinKnight extends GenericSpawnEvent {

    public SpawnTFLowerGoblinKnight(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp,
