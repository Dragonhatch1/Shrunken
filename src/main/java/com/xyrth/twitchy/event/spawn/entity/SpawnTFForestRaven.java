...
public class SpawnTFForestRaven extends GenericSpawnEvent {

    public SpawnTFForestRaven(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
