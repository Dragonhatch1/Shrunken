...
public class SpawnTFSlimeBeetle extends GenericSpawnEvent {

    public SpawnTFSlimeBeetle(World world, double x, double y, double z, EntityLivingBase targetEntity, int hp, int att,
